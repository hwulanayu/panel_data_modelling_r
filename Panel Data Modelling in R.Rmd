...
Data panel merupakan data dari beberapa individu sama yang diamati dalam kurun waktu tertentu. Data panel memiliki tiga jenis data, yaitu cross section, pooled cross section, dan panel. Jenis yang akan kita gunakan adalah panel data. Panel data adalah jenis data yang mengamati banyak subjek pada banyak titik atau periode waktu.
